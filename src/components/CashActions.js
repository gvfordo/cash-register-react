      ...
      <Col sm={{ size: 6, offset: 3 }}>
        ...
        >
          <CardBody style={{ paddingBottom: '4px' }}>
            {props.actionsList.add ? (
              <CashMovement addCash={props.addCash} action='add' />
            ) : null}
            {props.actionsList.take ? (
              <CashMovement addCash={props.addCash} action='take' />
            ) : null}
            {props.actionsList.change ? (
              <CashChange getChange={props.getChange} />
            ) : null}
          </CardBody>
        </Card>
      </Col>
        ...
        <Col sm='4' key={key} className='form-group'>
          <InputGroup size='sm'>
            ...
            <Input
              type='number'
              value={bills[key]}
              onChange={e => addCash(key, e.target.value)}
            />
          </InputGroup>
        </Col>
      ))}
    ...
    <Row>
      ...
      <Col sm='4' className='form-group'>
        <Button
          ...
          color='success'
          block
          onClick={() => props.getChange(cashCount)}
        >
          CHANGE
        </Button>
      </Col>
